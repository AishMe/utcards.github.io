...
const Header1: NextPage = () => {
  return (
    <header className="self-stretch flex flex-row items-center justify-start pt-[1.25rem] pb-[0rem] pr-[0rem] pl-[2.563rem] box-border gap-[3.438rem] max-w-full z-[2] text-left text-[1.563rem] text-primary-2 font-montserrat mq825:gap-[3.438rem]">
